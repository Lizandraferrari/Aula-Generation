...
Se houver, gravar na variável E (Excesso) e na variável M o valor da multa que João deverá pagar.
						...
						*/
			inteiro kg , multa=4 , excesso , deve

			escreva("Insira aqui quantos KG de tomate possui: \n")
			leia(kg)
			deve=(kg-50)*4

			se(kg>50){
				escreva("Você deve R$ ", deve , " ao governo >:D")
			}senao{
				escreva("Você não precisa pagar multa")
